...
struct MachineStatus {
    ...
    MachineStatus() : isOn(false), boilerTemperature(0.0f), preBrewMode(PreExtractionMode::DISABLED), 
                     preBrewTime(0.0f), preBrewWait(0.0f), isValid(false) {}
};
