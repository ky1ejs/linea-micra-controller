...
#define LINEA_MICRA_PREBREW_WAIT_ENTITY_ID "number.kyles_linea_micra_prebrew_off_time"      // Entity ID for pre-brew wait time
#define LINEA_MICRA_PREBREW_MODE_ENTITY_ID "select.kyles_linea_micra_prebrew_infusion_mode" // Entity ID for pre-brew infusion mode
